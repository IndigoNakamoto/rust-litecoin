...
//! the wire format implemented in `bitcoin::blockdata::mimblewimble` and the MWEB extension on
//! `Block` and `Transaction` matches what Litecoin Core produces.

#![cfg(feature = "std")]

use bitcoin::blockdata::mimblewimble::{KernelFeatures, OutputFeatures};
