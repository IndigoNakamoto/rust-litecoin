...
use litecoin::secp256k1::{rand, Message, Secp256k1, SecretKey, Signing};
...
fn main() {
    ...
    let signature = litecoin::ecdsa::Signature { signature, sighash_type };
...
fn senders_keys<C: Signing>(secp: &Secp256k1<C>) -> (SecretKey, WPubkeyHash) {
    ...
    let pk = litecoin::PublicKey::new(sk.public_key(secp));
