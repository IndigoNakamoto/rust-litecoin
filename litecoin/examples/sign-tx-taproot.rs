...
use litecoin::key::{Keypair, TapTweak, TweakedKeypair, UntweakedPublicKey};
use litecoin::locktime::absolute;
use litecoin::secp256k1::{rand, Message, Secp256k1, SecretKey, Signing, Verification};
use litecoin::sighash::{Prevouts, SighashCache, TapSighashType};
use litecoin::{
...
fn main() {
    ...
    let signature = litecoin::taproot::Signature { signature, sighash_type };
