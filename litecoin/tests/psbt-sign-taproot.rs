...
use litecoin::bip32::{DerivationPath, Fingerprint};
use litecoin::consensus::encode::serialize_hex;
use litecoin::opcodes::all::OP_CHECKSIG;
use litecoin::psbt::{GetKey, Input, KeyRequest, PsbtSighashType, SignError};
use litecoin::taproot::{LeafVersion, TaprootBuilder, TaprootSpendInfo};
use litecoin::transaction::Version;
use litecoin::{
